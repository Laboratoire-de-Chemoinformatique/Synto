"""
Module containing functions for running value network tuning with self-learning approach
"""
...
def run_training(processed_molecules_path=None, simul_id=None, config=None, experiment_root=None):
    """
    Performs the training stage in self-learning process. Trains a value network using a set of processed molecules and
...
def run_self_learning(config: dict):
    """
    Performs self-learning simulations with alternating planning and training stages

    :param config: The configuration settings for the self-learning process
    :type config: dict
    """
    ...
    logging_file = experiment_root.joinpath('self_learning.log')
